...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //
        // Create a concrete class from your abstract list item class and use this in a Linked List
        ...
        //      again (if there is not next item then that is where the new item belongs).
        //
        ...
        // classes that we create later, but if you use names that IntelliJ recognizes as Java classes (such
